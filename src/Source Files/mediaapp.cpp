...
//     QApplication::setFont(QFont("San Francisco"));
...
// {
//     QWidget *titleBar = new QWidget(this);
//     titleBar->setStyleSheet("background-color: rgba(255, 255, 255, 0.8);");

//     QGraphicsBlurEffect *blurEffect = new QGraphicsBlurEffect(this);
//     blurEffect->setBlurRadius(10);
//     titleBar->setGraphicsEffect(blurEffect);

//     QHBoxLayout *titleBarLayout = new QHBoxLayout(titleBar);
//     titleBarLayout->setContentsMargins(5, 0, 5, 0);

//     QLabel *titleLabel = new QLabel("     S N A C K - G U A R D", titleBar);
//     titleLabel->setStyleSheet("color: #333333; font-size: 20px; font-weight: bold;");
//     titleLabel->setAlignment(Qt::AlignCenter);
...
//     )");
//     closeButton->setFixedSize(30, 30);
//     connect(closeButton, &QPushButton::clicked, this, &MediaApp::close);
